...
/*-----------------    2023-1   ---------------------------*/
/*------------- No. de equipo: 10 ---------------*/
/*------------- Alumnos [No. de Cuenta]: Pérez Palumbo Fernando Alexis [314185970] ---------------*/
#include <Windows.h>
...
// camera
Camera camera(glm::vec3(-400.0f, 200.0f, 550.0f));
...
void animate(void)
{
    lightPosition.x = 400.0f * cos(myVariable);
    lightPosition.y = 300.0f * sin(myVariable);
    myVariable += 0.01f;
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        staticShader.setVec3("pointLight[0].diffuse", glm::vec3(0.3f, 0.3f, 0.3f));
        ...
        staticShader.setVec3("pointLight[1].position", glm::vec3(-300.0, 0.0f, 300.0f));
        staticShader.setVec3("pointLight[1].ambient", glm::vec3(0.0f, color, 0.8f));
        staticShader.setVec3("pointLight[1].diffuse", glm::vec3(0.0f, 0.0f, 0.0f));
        staticShader.setVec3("pointLight[1].specular", glm::vec3(0.0f, 0.0f, 0.0f));
        staticShader.setFloat("pointLight[1].constant", 1.0f);
        staticShader.setFloat("pointLight[1].linear", 0.000000009f);
        staticShader.setFloat("pointLight[1].quadratic", 0.00032f);

        staticShader.setVec3("pointLight[2].position", glm::vec3(-50.0f, 0.0f, 300.0f));
        staticShader.setVec3("pointLight[2].ambient", glm::vec3(on, 0.0f, 0.0f));
        ...
        staticShader.setFloat("pointLight[2].linear", 0.000000009f);
...
void my_input(GLFWwindow* window, int key, int scancode, int action, int mode)
{
    ...
    if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS)
        camera.ProcessKeyboard(FORWARD, (float)deltaTime + 50.0f);
    if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS)
        camera.ProcessKeyboard(BACKWARD, (float)deltaTime + 50.f);
    if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS)
        camera.ProcessKeyboard(LEFT, (float)deltaTime + 50.f);
    if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS)
        camera.ProcessKeyboard(RIGHT, (float)deltaTime + 50.f);
    //To Configure Model
